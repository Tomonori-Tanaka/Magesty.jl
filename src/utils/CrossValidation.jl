...
function cross_validation_with_a_weight(optimize::SCEOptimizer, weight::Real, splitted_dataset::Vector{Vector{SpinConfig}})
	for spinconfig_list in splitted_dataset
	end
end
