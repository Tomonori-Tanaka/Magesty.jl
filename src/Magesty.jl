...
# Prediction verbs (predict_energy / predict_torque) and the accuracy
# metrics (r2 / rss / residuals / rmse over energy and torque) for a
# (predictor, data) pair. Spliced into this module; see the file header for
# the in-scope dependencies.
include("Evaluation.jl")


# Combined energy+torque generalized cross-validation diagnostics
# (gcv / gcv_r2 / gcv_lambda / gcv_learning_curve plus the result types).
# Spliced into this module; see the file header for in-scope dependencies.
include("GCV.jl")
