...
| [260702-salc-projection-timerev-dedup](260702-salc-projection-timerev-dedup/) | complete (2026-07-02) | Deduplicate the `time_rev_sym`-independent work in `_projection_matrix_coupled_basis` (single-pass dual-buffer loop). Bit-identity gate PASS; projection stage 1.95x / -47% allocs, constructor 1.19x / -29% allocs on fege_2x2x2 |
