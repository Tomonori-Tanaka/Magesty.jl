...
| [260520-cli-foundation](260520-cli-foundation/) | draft (2026-05-20) | Comonicon-based `magesty` CLI foundation; VASP-to-extxyz promoted to API + `magesty vasp extxyz` subcommand |
