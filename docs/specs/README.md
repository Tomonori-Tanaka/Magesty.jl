...
| [260529-sce-sunny-export](260529-sce-sunny-export/) | merged (2026-05-29, PR #31) | `sce_to_sunny` exporter: emit a runnable Sunny.jl LSWT script from a fitted `SCEModel` (bilinear pairs + single-ion anisotropy; round-trip energy gate). |
