...
| [260702-salc-projection-timerev-dedup](260702-salc-projection-timerev-dedup/) | draft (2026-07-02) | Deduplicate the `time_rev_sym`-independent work in `_projection_matrix_coupled_basis` (single-pass dual-buffer loop); bit-identical output, target roughly -50% allocations in the heaviest SALC construction stage |
