...
| [260523-cluster-generation-perf](260523-cluster-generation-perf/) | draft (2026-05-23) | Replace `irreducible_clusters` O(N^2) linear scan with canonical-form `Dict` lookup; remove duplicate `set_mindist_pairs` call in `generate_clusters` |
