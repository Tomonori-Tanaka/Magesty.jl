...
| [260601-src-refactor](260601-src-refactor/) | draft (2026-06-01) | Architecture + hot-path cleanup from an `src/` review panel: encapsulate the angular-momentum coupling cache, de-duplicate the energy/torque Fitting kernel (conditional), and cut SALC / SH-cache allocations. Behavior-preserving. |
