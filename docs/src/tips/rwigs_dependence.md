...
![Fig. 1](../assets/rwigs_dependence/bccFe_1atom_tilt.jpeg)
...
![Fig. 2](../assets/rwigs_dependence/torque_r.jpg)
...
![Fig. 3](../assets/rwigs_dependence/jij_rwigs.jpg)
...
The Julia script used with Magesty.jl is as follows. It reads the system
definition from `input.toml`; see [Input Keys](../input_keys.md) for the
TOML format.
