...
println("relative error energy (energy): ", sclus_energy.optimize.relative_error_energy)
println("relative error energy (magfield_vertical): ", sclus_energy.optimize.relative_error_magfield_vertical)
println("relative error torque (energy): ", sclus_torque.optimize.relative_error_energy)
println("relative error torque (magfield_vertical): ", sclus_torque.optimize.relative_error_magfield_vertical)
